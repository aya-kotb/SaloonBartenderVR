...
*/
					...
					controllerCollisionDetector = Instantiate(customRigidbodyObject, transform.position, customRigidbodyObject.transform.rotation) as GameObject;
                    controllerCollisionDetector.transform.SetParent(transform);
					controllerCollisionDetector.transform.localScale = customRigidbodyObject.transform.localScale;
                    destroyColliderOnDisable = true;
